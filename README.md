...
`mvn verify sonar:sonar -Dmaven.test.skip=true -Dsonar.login=<Your authentication token from SonarCloud>`
(You can keep the test runs if you want, which will take longer time.)
